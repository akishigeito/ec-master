    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-lg">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-gray-900">EC連携管理システム</h1>
          <p className="mt-2 text-sm text-gray-500">商品マスタ管理にログインしてください</p>
        </div>
...
async function ErrorMessage({
  ...
  const messages: Record<string, string> = {
    oauth_error: 'Googleログインに失敗しました。再度お試しください。',
    auth_callback_error: '認証処理でエラーが発生しました。再度お試しください。',
  }
